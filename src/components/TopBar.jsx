      ...
      <div className="w-full max-w-[1360px] h-full px-6 lg:px-10 flex justify-between items-center gap-4">
        ...
        <div className="hidden lg:flex w-1/4 justify-end items-center gap-1.5 shrink-0">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.facebook.com/share/1DukVEsF6V/" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80">
              <img src="/asstes/facebook.svg" alt="Facebook" className="w-3.5 h-3.5" />
            </a>
            <a href="https://www.instagram.com/drift.financial1/" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 text-white"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            ...
            <a href="https://x.com/DriftFinancial0" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80">
