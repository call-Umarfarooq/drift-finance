      ...
      <div className="w-full max-w-[1360px] mx-auto flex flex-col justify-start items-center gap-5 lg:gap-16">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-8">
          {cards.map((card, index) => (
            <Link href={card.link} key={index} className="w-full px-6 py-8 lg:px-10 lg:py-12 bg-neutral-300 rounded-3xl flex flex-col justify-start items-center gap-2 lg:gap-6 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all cursor-pointer">
